...
import com.izatec.pontointeligente.api.dtos.LancamentoDto;
...
import com.izatec.pontointeligente.api.services.LancamentoService;
...
public class LancamentoController {
    ...
    public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
        ...
        Page<LancamentoDto> lancamentosDto = null; //lancamentos.map(lancamento -> this.converterLancamentoDto(lancamento));
